...
import 'package:joy_bor/features/notification/domain/usecases/get_all_notifications.dart';
...
void main() {
  late GetAllNotifications usecase;
  late MockNotificationRepository mockRepository;

  setUp(() {
    mockRepository = MockNotificationRepository();
    usecase = GetAllNotifications(mockRepository);
  });

  test('should get all notifications from the repository', () async {
    // arrange
    final notifications = [
      NotificationEntity(
        id: 1,
